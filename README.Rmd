...
You can verify that the log contains NO errors, warnings, or notes by going to the "Actions" tab in my GitHub repo and clicking on the TOP workflow (it should have a blue check mark beside it). 
